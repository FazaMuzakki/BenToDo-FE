  ...
  return (
    <>
      <style>{`
        ...
        .about-stats div {
          padding-left: 18px;
          border-left: 2px solid ${COLORS.green.primary};
        }
          ...
          <section className="hero">
            <div className="hero__inner">
              <div>
                ...
                <h1>
                  Atur tugas kuliah tanpa <span>overload</span>.
                </h1>
                <p className="hero__copy">
                  Bento-Do membantu mahasiswa mengelola bank tugas, memilih tiga prioritas utama,
                  menjaga energi harian, dan menerima reminder deadline dalam satu dashboard.
                </p>
          ...
          <section id="about" className="section">
            <div className="section__inner">
              <div className="about-band reveal">
                <div>
                  <div className="eyebrow">Tentang Bento-Do</div>
                  <div className="section-heading" style={{ marginBottom: 24 }}>
                    <h2>
                      Produktivitas yang tidak hanya soal <span>cepat selesai</span>.
                    </h2>
                  </div>
                  <p>
                    Bento-Do dibuat untuk final project WDUIUX sebagai jawaban atas masalah
                    mahasiswa: tugas terlalu banyak, onboarding tools terasa berat, dan energi
                    belajar sering habis sebelum pekerjaan benar-benar dimulai.
                  </p>
                </div>
                ...
                <div className="about-stats">
                  ...
                  <div>
                    <strong>0</strong>
                    <span>akun untuk coba awal</span>
                  </div>
                </div>
              </div>
            </div>
